...
const portfolioItems = [
  ...
  { id: 1, category: "Web", title: "NexaCloud Platform", description: "A SaaS dashboard with real-time analytics, dark mode, and blazing-fast performance. Built with Next.js and TypeScript.", tags: ["Next.js", "TypeScript", "Tailwind"], icon: Globe, gradient: "linear-gradient(135deg, #7B2FF7 0%, #1a0a3e 100%)", accentColor: "#7B2FF7", stat: "2× faster load time", featured: true, image: "/Images/portfolio/nexacloud.webp" },
  { id: 2, category: "Design", title: "Aura Brand Identity", description: "Complete brand overhaul including logo, color system, typography, and brand guidelines for a luxury beauty brand.", tags: ["Branding", "Figma", "Motion"], icon: Layers, gradient: "linear-gradient(135deg, #a855f7 0%, #2d1b69 100%)", accentColor: "#a855f7", stat: "300% engagement boost", featured: false, image: "/Images/portfolio/aura.webp" },
  { id: 3, category: "Video", title: "Orbital Launch Film", description: "Cinematic product launch video with VFX, color grading, and 3D animations that went massively viral.", tags: ["After Effects", "Premiere", "VFX"], icon: Play, gradient: "linear-gradient(135deg, #00C6FF 0%, #003d5c 100%)", accentColor: "#00C6FF", stat: "1M+ views in 48hrs", featured: true, image: "/Images/portfolio/orbital.webp" },
  { id: 4, category: "Web", title: "CryptoVault DeFi", description: "Decentralized finance platform with live charts, wallet integration, and a trading UI loved by thousands.", tags: ["React", "Web3", "D3.js"], icon: Globe, gradient: "linear-gradient(135deg, #38bdf8 0%, #0c2a4a 100%)", accentColor: "#38bdf8", stat: "$2M TVL in launch week", featured: false, image: "/Images/portfolio/cryptovault.webp" },
  { id: 5, category: "Design", title: "Luminary UI System", description: "A complete design system with 200+ components, tokens, and Figma auto-layout used by 50+ product teams.", tags: ["Figma", "Design Tokens", "UI Kit"], icon: Layers, gradient: "linear-gradient(135deg, #f472b6 0%, #4a0a2e 100%)", accentColor: "#f472b6", stat: "Used by 50+ teams", featured: false, image: "/Images/portfolio/luminary.webp" },
  { id: 6, category: "Video", title: "Nova Social Campaign", description: "Vertical video series for Instagram Reels and TikTok — strategy, script to final cut with 5M+ organic reach.", tags: ["Premiere", "Social", "Strategy"], icon: Play, gradient: "linear-gradient(135deg, #fb923c 0%, #3d1500 100%)", accentColor: "#fb923c", stat: "5M+ organic reach", featured: true, image: "/Images/portfolio/nova.webp" },
];
